...
export const dict = {
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'About OpenKei',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes OpenKei state, OpenCode health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate OpenKei efficiently',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock OpenKei',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote OpenKei servers',
  ...
  'multiRun.window.description': 'OpenKei Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to OpenKei',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If OpenKei does not detect OpenCode automatically, set the binary path below.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to OpenKei settings and reloads OpenCode configuration.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an OpenKei server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an OpenKei server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running OpenKei. Verify the address points to an OpenKei server.',
  ...
  'startup.initRecovery.description': 'OpenKei could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating OpenKei...',
  ...
  'openChamberLogo.aria.logo': 'OpenKei logo',
