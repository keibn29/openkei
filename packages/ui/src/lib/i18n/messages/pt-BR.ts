...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Sobre o OpenKei",
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do OpenKei, a integridade do OpenCode, diretórios e projetos.",
  ...
  "helpDialog.description": "Use estes atalhos de teclado para navegar pelo OpenKei com eficiência",
  ...
  "desktopHostSwitcher.description": "Alterne entre Local e o servidor remoto do OpenKei",
  ...
  "multiRun.window.description": "Janela do OpenKei Multi-Run.",
  ...
  "onboarding.chooser.title": "Boas-vindas ao OpenKei",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o OpenKei não detectar o OpenCode automaticamente, defina o caminho do executável a seguir.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do OpenKei e recarregue configurações do OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Digite o endereço de um servidor do OpenKei para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugestões: verifique se a URL aponta para um servidor OpenKei ou entre em contato com o administrador do servidor.",
  ...
  "onboarding.remoteConnection.probe.wrongServiceMessage": "O servidor respondeu, mas não está executando OpenKei. Verifique se o endereço aponta para um servidor OpenKei.",
  ...
  "startup.initRecovery.description": "O OpenKei não conseguiu concluir a inicialização. Verifique se o servidor está em execução e tente novamente.",
  ...
  "updateDialog.header.updating": "Atualizando OpenKei...",
  ...
  "openChamberLogo.aria.logo": "Logo do OpenKei",
