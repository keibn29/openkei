...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Acerca de OpenKei",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de OpenKei, el estado de OpenCode, directorios y proyectos.",
  ...
  "helpDialog.description": "Usa estos atajos de teclado para navegar por OpenKei de manera eficiente",
  ...
  "commandPalette.settingsGroup.opencode": "OpenKei",
  ...
  "sessionAuth.locked.unlockTitle": "Desbloquear OpenKei",
  ...
  "desktopHostSwitcher.description": "Cambia entre Local y el servidor remoto de OpenKei",
  ...
  "multiRun.window.description": "Ventana de OpenKei Multi-Run.",
  ...
  "onboarding.chooser.title": "Bienvenido a OpenKei",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si OpenKei no detecta OpenCode automáticamente, establece la ruta del ejecutable a continuación.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de OpenKei y recarga la configuración de OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Introduce la dirección de un servidor de OpenKei para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugerencias: Verifica que la URL apunte a un servidor OpenKei o contacta al administrador del servidor.",
  ...
  "onboarding.remoteConnection.probe.wrongServiceMessage": "El servidor respondió pero no está ejecutando OpenKei. Verifica que la dirección apunte a un servidor OpenKei.",
  ...
  "startup.initRecovery.description": "OpenKei no pudo completar la inicialización. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.",
  ...
  "updateDialog.header.updating": "Actualizando OpenKei...",
  ...
  "openChamberLogo.aria.logo": "Logo de OpenKei",
