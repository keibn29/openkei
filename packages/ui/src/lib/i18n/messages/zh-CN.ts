...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': '关于 OpenKei',
  ...
  'aboutDialog.diagnosticsDescription': '包含 OpenKei 状态、OpenCode 健康信息、目录和项目。',
  ...
  'helpDialog.description': '使用这些快捷键可更高效地导航 OpenKei',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 OpenKei',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 OpenKei 服务器之间切换',
  ...
  'multiRun.window.description': 'OpenKei 多运行窗口。',
  ...
  'onboarding.chooser.title': '欢迎使用 OpenKei',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 OpenKei 未自动检测到 OpenCode，请在下方设置可执行文件路径。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 OpenKei 设置并重新加载 OpenCode 配置。',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 OpenKei 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 OpenKei 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 OpenKei。请确认地址是否指向 OpenKei 服务器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 OpenKei。请确认地址是否指向 OpenKei 服务器。',
  ...
  'startup.initRecovery.description': 'OpenKei 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  ...
  'updateDialog.header.updating': '正在更新 OpenKei...',
  ...
  'openChamberLogo.aria.logo': 'OpenKei 标志',
