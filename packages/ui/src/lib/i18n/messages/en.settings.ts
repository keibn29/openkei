export const settingsDict = {
  ...
  'settings.window.description': 'OpenKei settings window.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Managed installs/updates and starts OpenKei remotely. External assumes it is already running.',
  ...
  'settings.remoteInstances.page.field.preferredRemotePortHint': 'Port OpenKei should use on the remote host. Leave empty to let the runtime choose.',
  'settings.remoteInstances.page.field.keepServerRunning': 'Keep server running',
  'settings.remoteInstances.page.field.keepServerRunningHint': 'If enabled, OpenKei daemon is left running remotely when you disconnect.',
  ...
  'settings.remoteInstances.page.field.preferredLocalPortHint': 'Preferred local port for the main OpenKei tunnel. Leave empty for auto-select.',
  ...
  'settings.openchamber.about.title': 'About OpenKei',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. OpenKei will scan it for folders containing',
  ...
  'settings.remoteInstances.page.section.remoteServerDescription': 'How OpenKei is managed and started on the remote host.',
  ...
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote OpenKei UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How OpenKei is installed when running in managed mode.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Installing OpenKei',
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Updating OpenKei',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by OpenKei.',
  ...
  'settings.github.page.flow.title': 'Authorize OpenKei',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from OpenKei.',
