...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Про OpenKei",
  ...
  "aboutDialog.diagnosticsDescription": "Містить стан OpenKei, стан OpenCode, каталоги та проєкти.",
  ...
  "helpDialog.description": "Використовуйте ці комбінації клавіш для ефективної навігації OpenKei",
  ...
  "sessionAuth.locked.unlockTitle": "Розблокувати OpenKei",
  ...
  "desktopHostSwitcher.description": "Перемикання між Local і віддаленими OpenKei серверами",
  ...
  "multiRun.window.description": "Вікно мультизапуску OpenKei.",
  ...
  "onboarding.chooser.title": "Ласкаво просимо до OpenKei",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Якщо OpenKei не визначає OpenCode автоматично, укажіть шлях до виконуваного файла нижче.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Зберігає налаштування в OpenKei і перезавантажує конфігурацію OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Введіть адресу сервера OpenKei для підключення.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Пропозиції: переконайтеся, що URL вказує на сервер OpenKei або зверніться до адміністратора сервера.",
  ...
  "onboarding.remoteConnection.probe.wrongServiceMessage": "Сервер відповів, але не працює OpenKei. Перевірте, чи адреса вказує на сервер OpenKei.",
  ...
  "startup.initRecovery.description": "OpenKei не зміг завершити ініціалізацію. Перевірте, що сервер запущений, і повторіть спробу.",
  ...
  "updateDialog.header.updating": "Оновлення OpenKei...",
  ...
  "openChamberLogo.aria.logo": "Логотип OpenKei",
